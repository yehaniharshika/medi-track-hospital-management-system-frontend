...
const PatientSection = () => {
  ...
  const handleEditPatient = (patient: Patient) => {
    ...
    setAge(patient.age);
    setPreviewImage(
      patient.patientImg ? `data:image/jpeg;base64,${patient.patientImg}` : null
                ...
                <Form>
                  ...
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control
                      ...
                      onChange={(e) => setChronic_diseases(e.target.value)}
                    />
                  </Form.Group>
                  ...
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control
                      ...
                      onChange={(e) => setLast_visit_date(e.target.value)}
                    />
                  </Form.Group>
                </Form>
              </Modal.Body>
                      ...
                      >
                        ...
                        <td className="px-4 py-2 border flex justify-center gap-2 h-[80px]">
                          <button
                            ...
                            onClick={(event) =>
                              handleDeletePatient(event, patient.patientId)
                            }
                          >
                            Delete
                          </button>
