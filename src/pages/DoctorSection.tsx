...
const DoctorSection = () => {
  ...
  const handleEditDoctor = (doctor: Doctor) => {
    ...
    setPreviewImage(
      doctor.doctorImg ? `data:image/jpeg;base64,${doctor.doctorImg}` : null
    );
    setDoctorImg(null);
                ...
                <Form>
                  ...
                  <Form.Group className="mb-3">
                    ...
                    >
                      ...
                      <option value="mbbs.(col),d. path md haematology">
                        MBBS.(Col),D. Path MD Haematology
                      </option>
                      <option value="mbbs.(col),d. path md-cardiology">
                        MBBS.(Col),D. Path MD Cardiology
                      </option>
                      <option value="mbbs.(col),d. path md-neurology">
                        MBBS.(Col),D. Path MD Neurology
                      </option>
                      <option value="mbbs.(col),d. path md-dermatology">
                        MBBS.(Col),D. Path MD Dermatology
                      </option>
                      <option value="mbbs.(col),d. path md-pediatrics">
                        MBBS.(Col),D. Path MD Pediatrics
                      </option>
                      <option value="mbbs.(col),d. path md-psychiatry">
                        MBBS.(Col),D. Path MD Psychiatry
                      </option>
                      <option value="mbbs.(col),d. path md-radiology">
                        MBBS.(Col),D. Path MD Radiology
                      </option>
                      <option value="mbbs.(col),d. path md-anesthesiology">
                        MBBS.(Col),D. Path MD Anesthesiology
                      </option>
                      <option value="mbbs.(col),d. path md-surgery">
                        MBBS.(Col),D. Path MD Surgery
                      </option>
                      <option value="md-medicine">MD General Medicine</option>
                      <option value="mbbs-md-cardiology">
                        MBBS. MD Cardiology
                      </option>
                      <option value="mbbs-md-neurology">
                        MBBS. MD Neurology
                      </option>
                      <option value="mbbs-md-dermatology">
                        MBBS. MD Dermatology
                      </option>
                      <option value="mbbs-md-pediatrics">
                        MBBS. MD Pediatrics
                      </option>
                      <option value="mbbs-md-psychiatry">
                        MBBS. MD Psychiatry
                      </option>
                      <option value="mbbs-md-radiology">
                        MBBS. MD Radiology
                      </option>
                      <option value="mbbs-md-surgery">MBBS. MD Surgery</option>
                      <option value="mbbs-md-medicine">
                        MBBS. MD General Medicine
                      </option>
                      <option value="mbbs-md-haematology">
                        MBBS. MD Haematology
                      </option>
                      ...
                      >
                        ...
                        <td className="px-4 py-2 border flex justify-center gap-2 h-[80px]">
                          <button
                            ...
                            onClick={(event) =>
                              handleDeleteDoctor(event, doctor.doctorId)
                            }
                          >
                            Delete
                          </button>
